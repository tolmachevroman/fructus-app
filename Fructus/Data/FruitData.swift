...
let fruitData: [Fruit] = [
    Fruit(
      ...
      Fruit(
        ...
        """,
        nutrition: ["126 kJ (30 kcal)","1.7 g","0.2 g","0.7 g","B1, B2, B3, B5, B6, B9, C","Calcium, Iron, Magnesium, Phosphorus, Potassium, Sodium"]
      ),
      Fruit(
        title: "Pomegranate",
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        nutrition: ["184 kJ (44 kcal)","6.15","0.58 g","0.88 g","A, B1, B2, B3, B5, B6, B9, C, E","Calcium, Iron, Magnesium, Manganese, Phosphorus, Potassium, Sodium, Zinc"]
      ),
      Fruit(
        title: "Mango",
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        nutrition: ["127 kJ (30 kcal)","6.2 g","0.15 g","0.61 g","A, B1, B2, B3, B5, B6, C","Calcium, Iron, Magnesium, Manganese, Phosphorus, Potassium, Sodium, Zinc"]
      ),
      Fruit(
        title: "Cherry",
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        nutrition: ["218 kJ (52 kcal)","10.39 g","0.17 g","0.26 g","A, B1, B2, B3, B5, B6, B9, C, E, K","Calcium, Iron, Magnesium, Manganese, Phosphorus, Potassium, Sodium, Zinc"]
      )
]
